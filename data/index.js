...
export const valveData = {
  Surgical: {
    ...
    // Pulmonary: surgicalPulmonaryValveData   // When ready
  },
  Transcatheter: {
    ...
    // Pulmonary: transcatheterPulmonaryValveData   // When ready
  }
};

// Export useful constants
export const IMPLANT_METHODS = ['Surgical', 'Transcatheter'];
export const VALVE_POSITIONS = ['Aortic', 'Mitral']; // Add others when ready